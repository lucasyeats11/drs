...
/* themes/custom/deposit_return_theme/templates/field/field--paragraph--field-add-card.html.twig */
class __TwigTemplate_5c854ed00cec310c1de1cb68cffa174e extends Template
{
    private $source;
    private $macros = [];
...
";
      ...
      ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 60
                    echo "        <div";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 60), "addClass", [0 => "field__item col-lg-4 col-md-12 card-container"], "method", false, false, true, 60), 60, $this->source), "html", null, true);
                    echo ">";
...
";
    ...
    {
        return "themes/custom/deposit_return_theme/templates/field/field--paragraph--field-add-card.html.twig";
    }
...
{% if label_hidden %}
  {% if multiple %}
    <div{{ attributes.addClass(classes, 'field__items row') }}>
      {% for item in items %}
        <div{{ item.attributes.addClass('field__item col-lg-4 col-md-12 card-container') }}>{{ item.content }}</div>
      {% endfor %}
    </div>
  {% else %}
    {% for item in items %}
...
{% endif %}
", "themes/custom/deposit_return_theme/templates/field/field--paragraph--field-add-card.html.twig", "/var/www/html/web/themes/custom/deposit_return_theme/templates/field/field--paragraph--field-add-card.html.twig");
    }
