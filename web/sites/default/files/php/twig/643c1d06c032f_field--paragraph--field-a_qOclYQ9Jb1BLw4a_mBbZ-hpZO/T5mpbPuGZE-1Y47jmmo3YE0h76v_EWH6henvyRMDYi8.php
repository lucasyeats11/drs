...
/* themes/custom/deposit_return_theme/templates/field/field--paragraph--field-add-example.html.twig */
class __TwigTemplate_e85dc296d0f4c9ba5304119aa7940006 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (($context["label_hidden"] ?? null)) {
            ...
            if (($context["multiple"] ?? null)) {
                // line 58
                echo "    <div";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null), 1 => "field__items row"], "method", false, false, true, 58), 58, $this->source), "html", null, true);
                echo ">
      ";
                // line 59
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 60
                    echo "        <div";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 60), "addClass", [0 => "field__item col-lg-4 col-md-12 example"], "method", false, false, true, 60), 60, $this->source), "html", null, true);
                    echo ">";
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 65
                    echo "      <div";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null), 1 => "field__item example col-lg-4 col-md-12"], "method", false, false, true, 65), 65, $this->source), "html", null, true);
                    echo ">";
    ...
    ";
            ...
            if (($context["multiple"] ?? null)) {
                // line 72
                echo "    <div class=\"field__items col-lg-4\">
      ";
            }
            // line 74
            echo "      ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                // line 75
                echo "        <div";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 75), "addClass", [0 => "field__item col-lg-4 col-md-12"], "method", false, false, true, 75), 75, $this->source), "html", null, true);
                echo ">";
...
";
    ...
    {
        return "themes/custom/deposit_return_theme/templates/field/field--paragraph--field-add-example.html.twig";
    }
...
{% if label_hidden %}
  {% if multiple %}
    <div{{ attributes.addClass(classes, 'field__items row') }}>
      {% for item in items %}
        <div{{ item.attributes.addClass('field__item col-lg-4 col-md-12 example') }}>{{ item.content }}</div>
      {% endfor %}
    </div>
  {% else %}
    {% for item in items %}
      <div{{ attributes.addClass(classes, 'field__item example col-lg-4 col-md-12') }}>{{ item.content }}</div>
    {% endfor %}
  {% endif %}
{% else %}
  <div{{ attributes.addClass(classes) }}>
    ...
    {% if multiple %}
    <div class=\"field__items col-lg-4\">
      {% endif %}
      {% for item in items %}
        <div{{ item.attributes.addClass('field__item col-lg-4 col-md-12') }}>{{ item.content }}</div>
      {% endfor %}
      {% if multiple %}
    </div>
    {% endif %}
...
{% endif %}
", "themes/custom/deposit_return_theme/templates/field/field--paragraph--field-add-example.html.twig", "/var/www/html/web/themes/custom/deposit_return_theme/templates/field/field--paragraph--field-add-example.html.twig");
    }
