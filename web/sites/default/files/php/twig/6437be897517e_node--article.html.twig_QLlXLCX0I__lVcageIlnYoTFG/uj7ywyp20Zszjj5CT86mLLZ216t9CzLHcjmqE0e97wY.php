...
/* themes/custom/deposit_return_theme/templates/node/node--article.html.twig */
class __TwigTemplate_a110ad5c5432b5a604a69cb4a6490341 extends Template
{
    private $source;
    private $macros = [];
...
($context["view_mode"] ?? null)) ? (("node--view-mode-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(($context["view_mode"] ?? null), 76, $this->source)))) : ("")), 6 => "article"];
        // line 79
...
";
    ...
    {
        return "themes/custom/deposit_return_theme/templates/node/node--article.html.twig";
    }
    ...
    {
        return array (  70 => 88,  66 => 87,  62 => 86,  58 => 85,  51 => 81,  46 => 79,  44 => 76,  43 => 75,  42 => 74,  41 => 73,  40 => 72,  39 => 70,);
    }
  ...
  <div class=\"container\">
    <div class=\"row\">
      <div class=\"col-lg-10 offset-lg-1\">
        <h1>{{ label }}</h1>
        {{ content.field_image }}
        <div class=\"date\">{{ node.created.value|format_date('custom', 'd/m/y') }}</div>
...
", "themes/custom/deposit_return_theme/templates/node/node--article.html.twig", "/var/www/html/web/themes/custom/deposit_return_theme/templates/node/node--article.html.twig");
    }
    
    public function checkSecurity()
    {
        static $tags = array("set" => 70);
        static $filters = array("clean_class" => 72, "escape" => 79, "format_date" => 87);
