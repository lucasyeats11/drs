...
/* themes/custom/deposit_return_theme/templates/field/field--paragraph--field-icons.html.twig */
class __TwigTemplate_424d10eef77d62d406044481052f2820 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (($context["label_hidden"] ?? null)) {
            ...
            if (($context["multiple"] ?? null)) {
                // line 58
                echo "    <div";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null), 1 => "row"], "method", false, false, true, 58), 58, $this->source), "html", null, true);
                echo ">
      ...
      ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 62
                    echo "        <div";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 62), "addClass", [0 => "col-lg-4 col-md-4 col-sm-4"], "method", false, false, true, 62), 62, $this->source), "html", null, true);
                    echo ">";
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 69
                    echo "      <div";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null), 1 => "col-lg-4"], "method", false, false, true, 69), 69, $this->source), "html", null, true);
                    echo ">";
...
";
    ...
    {
        return "themes/custom/deposit_return_theme/templates/field/field--paragraph--field-icons.html.twig";
    }
    ...
    {
        return array (  144 => 84,  140 => 82,  137 => 81,  126 => 79,  121 => 78,  117 => 76,  115 => 75,  109 => 74,  104 => 73,  100 => 71,  89 => 69,  84 => 68,  78 => 64,  67 => 62,  63 => 61,  56 => 58,  53 => 57,  51 => 56,  48 => 55,  46 => 52,  45 => 50,  43 => 46,  42 => 45,  41 => 44,  40 => 43,  39 => 41,);
    }
...
{% if label_hidden %}
  {% if multiple %}
    <div{{ attributes.addClass(classes, 'row') }}>
      <div class=\"col-lg-10 offset-lg-1\">
        <div class=\"row\">
      {% for item in items %}
        <div{{ item.attributes.addClass('col-lg-4 col-md-4 col-sm-4') }}>{{ item.content }}</div>
      {% endfor %}
      </div>
      </div>
    </div>
  {% else %}
    {% for item in items %}
      <div{{ attributes.addClass(classes, 'col-lg-4') }}>{{ item.content }}</div>
    {% endfor %}
  {% endif %}
{% else %}
...
{% endif %}
", "themes/custom/deposit_return_theme/templates/field/field--paragraph--field-icons.html.twig", "/var/www/html/web/themes/custom/deposit_return_theme/templates/field/field--paragraph--field-icons.html.twig");
    }
