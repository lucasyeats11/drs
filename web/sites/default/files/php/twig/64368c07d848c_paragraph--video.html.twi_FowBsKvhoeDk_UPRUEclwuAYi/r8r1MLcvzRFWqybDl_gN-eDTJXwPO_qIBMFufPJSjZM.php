...
class __TwigTemplate_cb39ba379415678d094cdcd1bbb7dcda extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        echo "</h3>
              ";
        // line 15
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_add_youtube_video", [], "any", false, false, true, 15), 15, $this->source), "html", null, true);
        echo "
              <div class=\"row\">
                <div class=\"col-lg-6\">
                  ";
        ...
        <div class=\"container\">
          <div class=\"row\">
            <div class=\"col-lg-10 offset-lg-1\">
              ...
              {{ content.field_add_youtube_video }}
              <div class=\"row\">
                <div class=\"col-lg-6\">
                  {{ content.field_text }}
                  {{ content.field_link }}
