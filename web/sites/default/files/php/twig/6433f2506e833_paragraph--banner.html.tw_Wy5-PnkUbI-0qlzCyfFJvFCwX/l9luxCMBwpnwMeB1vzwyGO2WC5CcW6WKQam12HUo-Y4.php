...
class __TwigTemplate_50e751004a0c3a2aac4704d5b76f8f3e extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        echo "
            ...
            <div class=\"image\">
              ";
        // line 17
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_image_upload", [], "any", false, false, true, 17), "fileuri", [], "any", false, false, true, 17), 17, $this->source), "html", null, true);
        echo "
              ";
        // line 18
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->extensions['Drupal\Core\Template\TwigExtension']->getFileUrl($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_image_upload", [], "any", false, false, true, 18), "entity", [], "any", false, false, true, 18), "field_media_image", [], "any", false, false, true, 18), "entity", [], "any", false, false, true, 18), "fileuri", [], "any", false, false, true, 18), 18, $this->source)), "html", null, true);
        echo "
              ";
        // line 19
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_image_upload", [], "any", false, false, true, 19), "entity", [], "any", false, false, true, 19), "field_media_image", [], "any", false, false, true, 19), "entity", [], "any", false, false, true, 19), "fileuri", [], "any", false, false, true, 19), 19, $this->source), "html", null, true);
        echo "
            </div>
      </div>
    ";
    ...
    {
        return array (  97 => 19,  93 => 18,  89 => 17,  83 => 14,  79 => 13,  75 => 12,  69 => 10,  65 => 9,  60 => 23,  58 => 9,  53 => 8,  46 => 7,  44 => 5,  43 => 4,  42 => 3,  41 => 1,);
    }
  ...
  <div{{ attributes.addClass(classes) }}>
    {% block content %}
      <div class=\"main-banner {{ content.field_background_colour.0|render|lower}}\">
            ...
            <div class=\"image\">
              {{ content.field_image_upload.fileuri }}
              {{ file_url(content.field_image_upload.entity.field_media_image.entity.fileuri) }}
              {{ content.field_image_upload.entity.field_media_image.entity.fileuri }}
            </div>
      </div>
    {% endblock %}
  </div>
