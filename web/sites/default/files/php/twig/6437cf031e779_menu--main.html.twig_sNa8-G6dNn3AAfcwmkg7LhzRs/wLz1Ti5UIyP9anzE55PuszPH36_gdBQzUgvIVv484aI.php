...
/* themes/custom/deposit_return_theme/templates/navigation/menu--main.html.twig */
class __TwigTemplate_18a390f1cc574a5049827c0d2c0b1571 extends Template
{
    private $source;
    private $macros = [];
...
($context["menu_level"] ?? null) == 0)) ? ("navbar-nav justify-content-end") : ("")), 1 => (((                // line 35
...
";
    ...
    {
        return "themes/custom/deposit_return_theme/templates/navigation/menu--main.html.twig";
    }
...
{% macro build_menu(items, attributes, menu_level) %}
  ...
  {% if items %}
    {%
      set ul_classes = [
        menu_level == 0 ? 'navbar-nav justify-content-end',
...
{% macro add_link(item, attributes, menu_level) %}
  ...
  <li{{ item.attributes.addClass(list_item_classes) }}>
    {% if menu_level == 0 and item.below %}
      {{ link(item.title, item.url, { 'class': link_class, 'role': 'button', 'aria-expanded': 'false', 'title': ('Expand menu' | t) ~ ' ' ~ item.title }) }}
...
{% endmacro %}
", "themes/custom/deposit_return_theme/templates/navigation/menu--main.html.twig", "/var/www/html/web/themes/custom/deposit_return_theme/templates/navigation/menu--main.html.twig");
    }
