...
class __TwigTemplate_7a5025d85efb86ee3dbf396be52b20ef extends Template
{
    private $source;
    private $macros = [];
...
{% macro menu_links(items, attributes, menu_level, parent, menu_name, icon_default, icon_path, toolbar_variant) %}
  ...
  {% endif %}
{% endmacro %}
", "@gin/navigation/menu--toolbar--gin.html.twig", "/var/www/html/web/themes/contrib/gin/templates/navigation/menu--toolbar--gin.html.twig");
    }
