...
";
          ...
          <div class=\"row\">
            <div class=\"col-10 offset-lg-1\">
              <div class=\"row\">
                ";
        // line 16
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_image_location", [], "any", false, false, true, 16), 0, [], "any", false, false, true, 16) == "left")) {
            // line 17
            echo "                  <div class=\"col-lg-5 offset-lg-2 image\">
                    ";
            // line 18
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_image_upload", [], "any", false, false, true, 18), 18, $this->source), "html", null, true);
            echo "
                  </div>
                  <div class=\"col-lg-5 content\">
                    <h2>";
            // line 21
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_title", [], "any", false, false, true, 21), 21, $this->source), "html", null, true);
            echo "</h2>
                    <p>";
            // line 22
            ...
            echo "                  <div class=\"col-lg-5 content\">
                    <h2>";
            // line 26
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_title", [], "any", false, false, true, 26), 26, $this->source), "html", null, true);
            echo "</h2>
                    <p>";
            // line 27
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_text", [], "any", false, false, true, 27), 27, $this->source), "html", null, true);
            echo "</p>
                  </div>
                  <div class=\"col-lg-5 offset-lg-2 image\">
                    ";
            // line 30
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_image_upload", [], "any", false, false, true, 30), 30, $this->source), "html", null, true);
            echo "
                  </div>
                ";
        }
    ...
    {
        return array (  119 => 33,  113 => 30,  107 => 27,  103 => 26,  100 => 25,  94 => 22,  90 => 21,  84 => 18,  81 => 17,  79 => 16,  72 => 11,  68 => 10,  63 => 40,  61 => 10,  56 => 9,  49 => 8,  47 => 6,  46 => 5,  45 => 4,  44 => 2,  41 => 1,);
    }
      ...
      <div class=\"text-image\">
        <div class=\"container\">
          <div class=\"row\">
            <div class=\"col-10 offset-lg-1\">
              <div class=\"row\">
                {% if content.field_image_location.0 == \"left\" %}
                  <div class=\"col-lg-5 offset-lg-2 image\">
