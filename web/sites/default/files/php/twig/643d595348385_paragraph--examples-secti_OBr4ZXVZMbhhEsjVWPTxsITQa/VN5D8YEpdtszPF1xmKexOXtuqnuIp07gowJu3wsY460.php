...
/* themes/custom/deposit_return_theme/templates/paragraphs/paragraph--examples-section.html.twig */
class __TwigTemplate_c9bfb5ed17f9eef2275d17052f8651ff extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        echo "
          ";
        // line 14
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_add_example", [], "any", false, false, true, 14), 14, $this->source), "html", null, true);
        echo "
        </div>
      </div>
    ";
    ...
    {
        return "themes/custom/deposit_return_theme/templates/paragraphs/paragraph--examples-section.html.twig";
    }
    ...
    {
        return array (  81 => 14,  77 => 13,  73 => 12,  69 => 10,  65 => 9,  60 => 18,  58 => 9,  53 => 8,  46 => 7,  44 => 5,  43 => 4,  42 => 3,  41 => 1,);
    }
    ...
    {% block content %}
      <div class=\"examples\">
        <div class=\"container\">
          ...
          {{ content.field_text }}
          {{ content.field_add_example }}
        </div>
      </div>
    {% endblock %}
  </div>
{% endblock paragraph %}
", "themes/custom/deposit_return_theme/templates/paragraphs/paragraph--examples-section.html.twig", "/var/www/html/web/themes/custom/deposit_return_theme/templates/paragraphs/paragraph--examples-section.html.twig");
    }
