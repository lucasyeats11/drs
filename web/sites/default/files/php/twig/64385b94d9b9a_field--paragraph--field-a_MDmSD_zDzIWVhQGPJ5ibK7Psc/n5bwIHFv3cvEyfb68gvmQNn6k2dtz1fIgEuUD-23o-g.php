...
/* themes/custom/deposit_return_theme/templates/field/field--paragraph--field-add-stat.html.twig */
class __TwigTemplate_3611f7e29a28a3d4d5beb37cbbabd7a4 extends Template
{
    private $source;
    private $macros = [];
...
";
      ...
      ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 60
                    echo "        <div";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 60), "addClass", [0 => "field__item col-lg-4 col-md-12 stat-container"], "method", false, false, true, 60), 60, $this->source), "html", null, true);
                    echo ">";
  ...
  ";
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                    // line 65
                    echo "      <div";
                    echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => ($context["classes"] ?? null), 1 => "field__item col-lg-4 col-md-12"], "method", false, false, true, 65), 65, $this->source), "html", null, true);
                    echo ">";
...
";
    ...
    {
        return "themes/custom/deposit_return_theme/templates/field/field--paragraph--field-add-stat.html.twig";
    }
...
{% if label_hidden %}
  {% if multiple %}
    <div{{ attributes.addClass(classes, 'field__items row') }}>
      {% for item in items %}
        <div{{ item.attributes.addClass('field__item col-lg-4 col-md-12 stat-container') }}>{{ item.content }}</div>
      {% endfor %}
    </div>
  {% else %}
    {% for item in items %}
      <div{{ attributes.addClass(classes, 'field__item col-lg-4 col-md-12') }}>{{ item.content }}</div>
    {% endfor %}
  {% endif %}
{% else %}
...
{% endif %}
", "themes/custom/deposit_return_theme/templates/field/field--paragraph--field-add-stat.html.twig", "/var/www/html/web/themes/custom/deposit_return_theme/templates/field/field--paragraph--field-add-stat.html.twig");
    }
