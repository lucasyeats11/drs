...
/* themes/custom/deposit_return_theme/templates/paragraphs/paragraph--cards.html.twig */
class __TwigTemplate_ed699fd66ff9180d752bfd34cb1f33b2 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_content($context, array $blocks = [])
    {
        ...
        <div class=\"container\">
          ";
        // line 12
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["content"] ?? null), "field_add_card", [], "any", false, false, true, 12), 12, $this->source), "html", null, true);
        echo "
        </div>
      </div>
    ";
    ...
    {
        return "themes/custom/deposit_return_theme/templates/paragraphs/paragraph--cards.html.twig";
    }
    ...
    {
        return array (  73 => 12,  69 => 10,  65 => 9,  60 => 16,  58 => 9,  53 => 8,  46 => 7,  44 => 5,  43 => 4,  42 => 3,  41 => 1,);
    }
...
{% block paragraph %}
  <div{{ attributes.addClass(classes) }}>
    {% block content %}
      <div class=\"cards\">
        <div class=\"container\">
          {{ content.field_add_card }}
        </div>
      </div>
    {% endblock %}
  </div>
{% endblock paragraph %}
", "themes/custom/deposit_return_theme/templates/paragraphs/paragraph--cards.html.twig", "/var/www/html/web/themes/custom/deposit_return_theme/templates/paragraphs/paragraph--cards.html.twig");
    }
